...
checkPassword = async (username, plaintextPassword) => {
    ...
    if (globalStore[username]) {
        ...
        if (result) {
            ...
            console.log(`You are in the system ${username}!`)
        }
        else {
            // TODO: Display message for invalid credentials
            console.log(`You are not in the system yet you stranger!`)
        }
    }
    else {
...
hashPassword = async (username, password) => {
    ...
    console.log(`You are finally added to the system ${username}, the password hash is ${hashedPassword}`)
}
